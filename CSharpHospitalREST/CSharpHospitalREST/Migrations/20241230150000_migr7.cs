        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FatalOutcome = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MedicamentsId = table.Column<long>(type: "bigint", nullable: false),
                    PatientDiseasesId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicamentPatientDisease", x => new { x.MedicamentsId, x.PatientDiseasesId });
                    table.ForeignKey(
